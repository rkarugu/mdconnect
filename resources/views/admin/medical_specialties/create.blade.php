    ...
    <div class="max-w-3xl mx-auto">
        <div class="md:flex md:items-center md:justify-between mb-6">
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4">
                <a href="{{ route('admin.medical_specialties.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.medical_specialties.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
